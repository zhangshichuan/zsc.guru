		...
		<div className="min-h-screen bg-gray-50">
			...
			<header className="relative py-20 text-center bg-gradient-to-r from-blue-600 to-indigo-600">
				<div className="max-w-4xl mx-auto px-4">
					<img
						...
						alt="Avatar"
					/>
					<h1 className="text-4xl font-bold text-white mb-4">Max Zhang</h1>
					<p className="text-xl text-blue-100">开发 & 产品</p>
			...
			<main className="max-w-6xl mx-auto px-4 py-12">
				...
				<section className="mb-20">
					<h2 className="text-3xl font-bold text-gray-800 mb-8">关于我</h2>
				...
				{/* 项目展示 */}
				<section className="mb-20">
					<h2 className="text-3xl font-bold text-gray-800 mb-8">精选项目</h2>
				...
				<section className="text-center py-12 bg-white rounded-xl shadow-lg">
					<h2 className="text-3xl font-bold text-gray-800 mb-4">保持联系</h2>
					<p className="text-gray-600 mb-8 max-w-xl mx-auto">如果你有任何问题或想讨论合作机会，欢迎随时联系我</p>
					<a
